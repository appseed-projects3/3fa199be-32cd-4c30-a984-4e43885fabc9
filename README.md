...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-03-25 15:21`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/3fa199be-32cd-4c30-a984-4e43885fabc9.git
$ cd 3fa199be-32cd-4c30-a984-4e43885fabc9
```
